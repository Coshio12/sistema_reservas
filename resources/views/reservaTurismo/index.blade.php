...
<body>
    <x-app-layout>
        ...
        <div class="p-6">
            @include('reservaTurismo.modalCrear')
                    ...
                    <table class="min-w-full">
                        <thead class="bg-white border-b">
                            <tr>
                                ...
                                <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">Fecha Reserva</th>
                                <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">Hora Inicio</th>
                                <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">Hora Final</th>
                                <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">Guia Encargado</th>
                                <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">Cantidad Persona</th>
                                <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">Costo Turismo</th>
                                <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">Paquete</th>
                                <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">Descripcion Paquete</th>
                                <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">Persona</th>
                        ...
                        <tbody> 
                            ...
                            @foreach ($reserva_turismo as $reserva)
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{$reserva->guia_encargado}}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{$reserva->cantidad_personas}}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{$reserva->costo_turismo}}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{$reserva->paquetes_turismo->nombre_paquetes}}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{$reserva->paquetes_turismo->descripcion_paquetes}}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                            ...
                                            <div class="py-1">
                                                <a href="{{url('/reservaTurismo/edit/'.$reserva->id_reserva_turismo)}}" class="text-center flex p-2.5 bg-yellow-500 rounded-xl hover:rounded-3xl hover:bg-yellow-600 transition-all duration-300 text-white items-center justify-center">  
                                                        Editar
                                                </a>
                                                <br>
                                                <form action="{{url('/reservaTurismo/delete/'.$reserva->id_reserva_turismo)}}" method="post">
