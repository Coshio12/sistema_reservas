        ...
        <div class="max-w-md w-full p-6 bg-white rounded-lg shadow-lg my-20 mx-20" >
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="flex items-center justify-end mt-4">
                    <a class="underline text-sm text-black hover:text-[#95172d] dark:hover:text-[#95172d] rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('login') }}">
                        {{ __('¿Ya registrado?') }}
                    </a>
