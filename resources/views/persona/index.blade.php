                        ...
                        <tbody>                        
                            @foreach ($personas as $persona)
                                <tr class="bg-white border-b">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{$persona->id_persona}}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{$persona->nombre_persona}}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{$persona->apellido_persona}}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{$persona->celular_persona}}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{$persona->correo_persona}}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
 
                                            <div class="py-1">
                                                <a href="{{url('/persona/edit/'.$persona->id_persona)}}" class="text-center flex p-2.5 bg-yellow-500 rounded-xl hover:rounded-3xl hover:bg-yellow-600 transition-all duration-300 text-white items-center justify-center">  
                                                        Editar
                                                </a>
                                                <br>
                                                <form action="{{url('/persona/delete/'.$persona->id_persona)}}" method="post">
